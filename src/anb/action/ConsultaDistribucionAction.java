...
public class ConsultaDistribucionAction extends MappingDispatchAction {
    private final GeneralNeg gen = new GeneralNeg();

    public ActionForward consultadistribucionidx(ActionMapping mapping, ActionForm form, HttpServletRequest request,
