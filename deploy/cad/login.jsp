...
<body class="login">
    ...
    <div class="text-center">            
        <footer class="footer">
            <span class="text-muted center">&copy; ${sessionScope.GESTION} <a target="_blank" href="http://www.aduana.gob.bo">Aduana Nacional</a>. <span class="hidden-xs">Todos los derechos reservados. </span> Versión ${sessionScope.VERSION} </span>
