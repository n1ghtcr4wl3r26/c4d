    ...
    <div class="modal-body form-horizontal">
        <html:form styleId="form-asigna" action="generaridx.do">
            ...
            <div class="btn-container">
                <button type="submit" id="botonsubmit" onclick="consultar()" class="btn btn-primary" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Generar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>            
            </div>
            <div class="form-group">
                ...
                <label class="label-message-info">
                    El &uacute;ltimo n&uacute;mero m&aacute;ximo generado es el <%=Util.devuelveMaximo()%>
                </label>
            </div>
        </html:form>
    </div>
