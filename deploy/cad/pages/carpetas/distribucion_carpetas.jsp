    ...
    <div class="modal-body form-horizontal">
        <html:form styleId="form-distribucioncarpetas" action="distribucioncarpetas.do">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <html:text property="numerodesde" styleId="numerodesde" maxlength="20" styleClass="form-control required numeric" size="15"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">N&uacute;mero de Carpeta Hasta:</label>
                <div class="col-sm-3">
                    <html:text property="numerohasta" styleId="numerohasta" maxlength="20" styleClass="form-control required numeric" size="15"/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="btn-container">
                <button type="submit" id="botonsubmit" onclick="consultar()" class="btn btn-primary" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Distribuir&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>            
            </div>
            <div class="form-group">
...
<script>
    ...
    function asig(){
        Anb.confirm('¿Está seguro de distribuir las carpetas?', function () {
            $("#opcion").val('Asignar'); 
